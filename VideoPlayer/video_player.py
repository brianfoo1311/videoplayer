...
def update_video_clicked():
    status_lbl.configure(text="Update Button was clicked")
...
header_lbl = tk.Label(window, text="Select an option by clicking one of the buttons below", bg='#6495ED')
...
status_lbl = tk.Label(window, text="", font=("Helvetica", 10), bg='#6495ED')
